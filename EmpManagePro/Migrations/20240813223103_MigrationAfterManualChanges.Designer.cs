...
namespace EmpManagePro.Migrations
{
    ...
    [Migration("20240813223103_MigrationAfterManualChanges")]
    partial class MigrationAfterManualChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmpleadoDeduccion", b =>
                {
                    ...
                    b.HasKey("DeduccionID", "EmpleadoID");

                    b.HasIndex("EmpleadoID");

                    b.ToTable("EmpleadoDeduccion");
                });
