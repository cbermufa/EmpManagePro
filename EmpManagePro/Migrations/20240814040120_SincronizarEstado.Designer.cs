...
namespace EmpManagePro.Migrations
{
    ...
    [Migration("20240814040120_SincronizarEstado")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeduccionEmpleado", b =>
                {
                    b.Property<int>("DeduccionesDeduccionID")
                        .HasColumnType("int");

                    b.Property<string>("EmpleadosEmpleadoID")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("DeduccionesDeduccionID", "EmpleadosEmpleadoID");

                    b.HasIndex("EmpleadosEmpleadoID");

                    b.ToTable("DeduccionEmpleado");
                });
            ...
            modelBuilder.Entity("EmpManagePro.Models.Empleado", b =>
                {
                    ...
                    b.Property<string>("BonificacionesID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EmpleadoBonificacion", b =>
                {
                    b.Property<string>("EmpleadoID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("EmpleadoBonificaciones");
                });

            modelBuilder.Entity("EmpleadoDeduccion", b =>
                {
                    b.Property<string>("EmpleadoID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DeduccionEmpleado", b =>
                {
                    b.HasOne("EmpManagePro.Models.Deduccion", null)
                        .WithMany()
                        .HasForeignKey("DeduccionesDeduccionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmpManagePro.Models.Empleado", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmpleadoBonificacion", b =>
                {
                    b.HasOne("EmpManagePro.Models.Bonificacion", "Bonificacion")
                        .WithMany("EmpleadoBonificaciones")
            ...
            modelBuilder.Entity("EmpManagePro.Models.Bonificacion", b =>
                {
                    b.Navigation("EmpleadoBonificaciones");
                });
